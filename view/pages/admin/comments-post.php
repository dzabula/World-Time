...
if($_SESSION['user']->id_role != 3){
    ...
    $id = $_GET['id'];
    $comments = GetAllCommentForVest($id);
...
<script>
    window.onload = () =>{
        ...
        $(".ban").click(function(){SendBan($(this).attr("id-ban"))});
...
<table class="table table-striped table-hover">
            ...
            <div id="modal" class="col-10">
                ...
                <div class="modal-content">
                    ...
                    <p class="fs-4" id="text-filed">
                        
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, aliqua
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, aliqua
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, aliqua
